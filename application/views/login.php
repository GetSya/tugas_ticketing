      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-0 shadow rounded-3 my-5">
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-light fs-5">Sign In <strong> Pengguna</strong></h5>
            <form id="formLogin">
              ...
              <div class="form-floating mb-3">
                ...
                <input type="password" name="member_password" required class="form-control" id="floatingPassword" placeholder="Password">
              </div>
              ...
              <div class="d-grid mb-2">
                <a href="<?php echo base_url()?>client/register" class="btn btn-primary btn-login fw-bold" >
            ...
            <div class="text-left">
                <a href="<?php echo base_url()?>admin/master" class="small">Login Sebagai Admin</a>
              </div>
          </div>
