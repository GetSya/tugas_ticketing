    ...
    <script type="text/javascript">
		$(document).ready(function(){
			...
			$("#formTambahAdmin").submit(function(e){
				...
				$.ajax({
					url:'<?=base_url()?>admin/master/admin_tambah',
					dataType:'json',
					method:'POST',
					data:data_input,
					success:function(res){
						...
						if(status=="1")
						{
							window.location.assign('<?=base_url()?>admin/master');
						}
					}
				});
			});
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-0 shadow rounded-3 my-5">
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-light fs-5">Sign Up <strong> Admin</strong></h5>
            <form id="formTambahAdmin">
              ...
              <div class="d-grid mb-2">
                <a href="<?php echo base_url()?>admin/master" class="btn btn-primary btn-login fw-bold" >
